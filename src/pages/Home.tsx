        ...
        <div className="relative z-10 h-full flex flex-col justify-center items-center md:items-start px-6 md:px-24 max-w-7xl pt-12 md:pt-0 translate-y-6 md:translate-y-0">
          ...
          >
            <Link to="/collections" className="w-full sm:w-auto flex justify-center sm:justify-start">
              <button className="w-[85%] sm:w-auto bg-tertiary text-white px-6 md:px-10 py-3 md:py-4 rounded-sm font-label uppercase tracking-widest hover:bg-white hover:text-primary transition-all duration-500 text-[10px] md:text-xs font-bold shadow-xl">
                Shop Now
              </button>
            </Link>
            <Link to="/lookbook" className="w-full sm:w-auto flex justify-center sm:justify-start">
              <button className="w-[85%] sm:w-auto border border-white/40 text-white px-6 md:px-10 py-3 md:py-4 rounded-sm font-label uppercase tracking-widest hover:bg-white/10 transition-all duration-300 backdrop-blur-sm text-[10px] md:text-xs font-bold">
                Explore Lookbook
              </button>
            </Link>
          </motion.div>
